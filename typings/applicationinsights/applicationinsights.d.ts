...
interface Client {
    ...
    trackRequest(request: any /* http.ServerRequest */,
    ...
    getEnvelope(data: ContractsModule.Data<ContractsModule.Domain>,
                tagOverrides?: {
                    [key: string]: string;
     ...
     */
    track(data: ContractsModule.Data<ContractsModule.Domain>,
          tagOverrides?: {
              [key: string]: string;
          }): void;
}
