...
declare module uiGrid {
    ...
    export interface IGridInstanceOf<TEntity> {
         ...
         */
        clearAllFilters(refreshRows: boolean,
    ...
    export module importer {
        ...
        export interface IGridOptions<TEntity> {
             ...
             */
            importerErrorCallback?: (grid: IGridInstanceOf<TEntity>,
                                     errorKey: string,
    ...
    export module treeBase {
        ...
        export interface IColumnDef<TEntity> {
             ...
             */
            customerTreeAggregationFn?: (aggregation: IGridTreeBaseAggregationObject,
                                         fieldValue: any,
                                         numValue: number,
                                         row: IGridRowOf<TEntity>) => void;
            /**
        ...
        export interface IGridTreeBaseCustomAggregation<TEntity> {
            label: string;
            aggregationFn: (aggregation: IGridTreeBaseAggregationObject,
                            fieldValue: any,
                            numValue: number,
                            row?: IGridRowOf<TEntity>) => void;
